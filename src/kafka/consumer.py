...
from settings import BOOTSTRAP_SERVERS, PRODUCE_TOPIC_ACTUALLOAD_CSV
...
if __name__ == '__main__':
    ...
    parser.add_argument('--topic', type=str, default=PRODUCE_TOPIC_ACTUALLOAD_CSV)
    ...
    csv_consumer = ActualLoadProd(props=config)
